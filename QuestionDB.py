...
def insert_question(course, professor, year, image_path, db_name='questions', host='localhost', user='Aarav', password='Aarav@TopicOverflow!'):
    # Connect to MySQL database
    conn = mysql.connector.connect(
        host=host,
        user=user,
...
def process_pdf(pdf_path):
    ...
    for course, professor, year, image_path in questions:
        insert_question(course, professor, year, image_path)
